...
Read `netlify-database/SKILL.md` for Netlify Database — the GA managed Postgres product with Drizzle ORM, migrations, and preview branching. Covers the legacy "Netlify DB" extension in `references/legacy-extension.md`.
